...
#ifdef CONFIG_L4
		if (user_mode(regs))
			fault = copy_from_user(&tinstr, (void __user *)ptr, sizeof(tinstr));
		else
#endif
...
#ifdef CONFIG_L4
				if (user_mode(regs))
					fault = copy_from_user(&tinst2, (void __user *)(ptr + 1), sizeof(tinst2));
				else
#endif
...
#ifdef CONFIG_L4
		if (user_mode(regs))
			fault = copy_from_user(&instr, (void __user *)instrptr, sizeof(instr));
		else
#endif
